...
@menu('XR/Interaction/InteractableEvents')
export class InteractableEvents extends IXrInteractable {
    ...
    public onDisable () {
        ...
        this.node.off(XrControlEventType.HOVER_STAY, this._hoverStay, this);
        ...
        this.node.off(XrControlEventType.SELECT_STAY, this._selectStay, this);
