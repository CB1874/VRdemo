module.exports = {
    ...
    webXRSessionController: {
        defaultSessionMode: 'WebXR session mode',
    },
    hmd_ctrl: {
    ...
    action: {
        ...
        fallback: {
            displayMethod: 'AR Display of the fallback effect.',
            distance: 'Distance between the virtual content and the camera',
            fallBackScene: 'The name of the scene to jump to when fallback.',
        },
    },
    factor: {
        plane_direction: {
    ...
    tracking: {
        ...
        enableFallBack: 'Controls whether degradation is enabled on native/web, skips the Factor and executes Fallback in the Action directly.',
        enableNativeFallBack: 'Controls whether the native side enables third-party libraries to perform image recognition and whether Fallback action is performed. ',
        enableWebFallBack: 'Controls whether the web side enables third-party libraries to perform image tracing.',
        ...
        fallback: 'This action is performed on devices that do not support AR capabilities to control how virtual content is displayed and placed.',
    ...
    screen_touch_gesture: {
        ...
        placeAction: {
            ...
            distance: 'Set the distance between the interactivity and the interactivity.',
            detectOcclusion: 'Sets whether the placement of interactive objects is blocked.',
            located_Prefab: 'A prefab for positioning virtual objects.',
    ...
    builder: {
        ...
        foveation_level: 'Adjust the foveation level, higher level will result in lower GPU load, but the edges of the eye render texture will be blurred',
    },
    videoplayer: {
        ...
        playbackRate: 'The Video playback rate.(0.0 ~ 2.5)',
    ...
    webview: {
        url: 'Webpage URL',
        content: 'Associated WebViewContent with a MeshRenderer component as a webview material rendering target',
    },
    spatialAudio: {
        ...
        distanceRolloffModel: 'Representing different distance effect rolloff models',
    ...
    compositionLayer: {
        rtcamera: 'render camera, whose visible content is rendered into the composition layer ',
        rtwidth: 'Width of the render target texture in the render camera ',
        rtheight: 'Height of the render target texture in the render camera ',
        layertype: 'Composite layer types: Underlay and Overlay',
        shapetype: 'Composite layer shapes: Quad and Cylinder',
        locktype: 'Composite layer lock types: WorldLock (does not follow head rotation) and HeadLock (follows head rotation) ',
        depth: 'Composite layer depth: (Underlay)2/1/0 [EyeBuffer] (Overlay)0/1/2',
        cylinderradius: 'Radius of cylinder layer ',
        cylindercentralangle: 'Center Angle of cylinder layer ',
        texturetype: 'Composite layer texture type: Static and Dynamic',
        staticimage: 'Static Texture source',
    },
    passthrough: {
        opacity: 'The opacity factor in range 0.0 to 1.0.',
    },
};
